...
//drawing_register_add.txt Create Here
	subsequent_sync_metaData_add('drawing_register', 'project_id, title, pdf_name, number, revision, comments, tag, attribute1, attribute2, last_modified_date, last_modified_by, created_date, created_by, resource_type, id, is_deleted', $projectId, $new_project, 'id');
	
//drawing_register_update.txt Create Here
	subsequent_sync_metaData_update('drawing_register', 'id, project_id, title, pdf_name, number, revision, comments, tag, attribute1, attribute2, last_modified_date, last_modified_by, created_date, created_by, resource_type, is_deleted', $projectId);
