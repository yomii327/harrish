...
//Condition to stop duplicate records Dated : 22-03-2013	
									$checkData = array();
									$checkData = $db->selQRYMultiple('graphic_id', 'inspection_graphics', 'project_id = "'.$jDataGraphic['project_id'].'" AND graphic_id = "'.$jDataGraphic['global_id'].'" AND is_deleted=0');
...
//Condition to stop duplicate records Dated : 22-03-2013	
									$checkData = array();
									$checkData = $db->selQRYMultiple('issued_to_inspections_id', 'issued_to_for_inspections', 'project_id = "'.$jDataInspection['project_id'].'" AND issued_to_inspections_id = "'.$jDataInspection['global_id'].'" AND is_deleted=0');
