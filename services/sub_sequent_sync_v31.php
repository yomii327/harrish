...
//inspection_issue_to_add.txt Create Here
	subsequent_sync_metaData_add('inspection_issue_to', 'issue_to_name, last_modified_date, last_modified_by, created_date, created_by, resource_type, issue_to_id, project_id, is_deleted, tag, issue_to_email, company_name', $projectId, $new_project,"issue_to_id");
	
//inspection_issue_to_update.txt Create Here
	subsequent_sync_metaData_update('inspection_issue_to', 'issue_to_id, project_id, issue_to_name, last_modified_date, last_modified_by, created_date, created_by, resource_type, is_deleted, tag, issue_to_email, company_name', $projectId);
...
//drawing_register_add.txt Create Here
	subsequent_sync_metaData_drawing_register_add('drawing_register', 'id, project_id, title, pdf_name, number, revision, comments, tag, attribute1, attribute2, last_modified_date, last_modified_by, created_date, created_by, resource_type, is_deleted, is_approved', $projectId, $new_project, 'id');
	
//drawing_register_update.txt Create Here
	subsequent_sync_metaData_drawing_register_update('drawing_register', 'id, project_id, title, pdf_name, number, revision, comments, tag, attribute1, attribute2, last_modified_date, last_modified_by, created_date, created_by, resource_type, is_deleted, is_approved', $projectId);
