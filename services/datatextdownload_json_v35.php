...
//Files crate Here
		if(empty($lastModifiedDate)){//Modified Date not comes form device
			include('first_sync_v35.php');
		}else{//Modified Date comes form device
			include('sub_sequent_sync_v35.php');
		}
...
function first_sync_metaData($table, $colString, $projectArray, $tableNameForIpad = ''){
...
function subsequent_sync_metaData_add($table, $colString, $projectArray, $new_project, $global_id, $tableNameForIpad = ''){
	global $lastModifiedDate;
	global $db;
	$queryArray = array();
	foreach($projectArray as $project){
...
function subsequent_sync_metaData_update($table, $colString, $projectArray, $tableNameForIpad = ''){
	global $lastModifiedDate;
	global $db;
	global $deviceType;
	$queryArray = array();
