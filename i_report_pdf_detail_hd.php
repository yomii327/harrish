...
$limit = 19;
	$issued_to_add = '';$mulIssueTo = ''; $issToForInspWhere = '';
				...
				<tr>
					<td width="50%" valign="top" cellspacing="0" cellpadding="0" style="border-bottom:hidden;border-right:hidden;">
						<table class="collapse" width="100%" border="0" style="margin-left:-3px;margin-top:-3px;border-bottom:hidden;">
							<tr>
								...
								<td width="50%" style="font-size:11px;">'.stripslashes(wordwrap($obj->subLocations($fi[1], ' > '), 23, '<br />')).'</td>
							</tr>
							<tr>
						...
						$html .='</td>
							...
							<tr>
								...
								<td width="50%" style="font-size:11px;">'.stripslashes($fi[3]).'</td>
							</tr>
							<tr>
								<td width="50%" style="background-color:#CCCCCC;"><i>Inspection&nbsp;Type</i></td>
								<td width="50%" style="font-size:11px;">'.stripslashes($fi[4]).'</td>
							</tr>
							<tr>
							<td width="50%" style="background-color:#CCCCCC;"><i>Raised&nbsp;By</i></td>
								<td width="50%" style="font-size:11px;">'.stripslashes($fi[13]).'</td>
							</tr>
							<tr>
							<td width="50%" style="background-color:#CCCCCC;"><i>Issued&nbsp;To</i></td>
								<td width="50%" style="font-size:11px;">'.$issueToData_issueToName.'</td>
							</tr>
							<tr>
								<td width="50%" style="background-color:#CCCCCC;"><i>Fix by Date</i></td>
								<td width="50%" style="font-size:11px;">'.$issueToData_fixedByDate.'</td>
							</tr>
							<tr>
					...
					<td width="50%" valign="top" cellspacing="0" cellpadding="0" style="border-bottom:hidden;">
						<table class="collapse" width="103%" border="0" style="margin-left:-8px;margin-top:-3px;border-right:hidden;">
							...
							<tr>
								<td width="50%" style="padding-left:3px;height:100px;font-size:11px;" valign="top">'.stripslashes(substr($fi[9], 0, 200));
									if(strlen($fi[9]) > 200){
										$html .='......';
									}
						$html .='</td>
				...
				<tr>
					...
					if(isset($images[1]) && $images[1]['graphic_name'] != ''){
						...
						if(file_exists('inspections/photo/'.$images_path.$images[1]['graphic_name'])){
							$html .='<img src="inspections/photo/'.$images_path.$images[1]['graphic_name'].'" /></td>';
						}else{
					...
					$html .='</tr><tr><td align="center" style="width:180px;height:130px;font-size:11px;" colspan="2">';
