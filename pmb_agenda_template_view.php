...
<table width="98%" border="0" style=" margin:10px;" cellpadding="2" cellspacing="5">
 ...
 <tr>
  ...
  <tr>
    <td width="27%" height="22" valign="top" ><strong>Agenda for meeting number</strong>&nbsp;</td>
  ...
  <tr>
    <td height="22" valign="top"><strong>Meeting Description </strong>&nbsp;</td>
    <td colspan="3" valign="top"><?php echo $meetingData[0]['title']; ?>&nbsp;</td>
    </tr>
  <tr>
    <td height="22" valign="top"><strong>Held at </strong>&nbsp;</td>
    <td colspan="3" valign="top"><?php echo $meetingData[0]['held_at']; ?>&nbsp;</td>
    </tr>      
  <tr>
    <td height="22" valign="top"><strong>Date </strong>&nbsp;</td>
    <td width="9%" valign="top"><?php echo date('d/m/Y' ,strtotime($meetingData[0]['date'])); ?>&nbsp;</td>
    <td width="6%" valign="top"><strong>Time </strong>&nbsp;</td>
    <td width="58%" valign="top"><?php echo $meetingData[0]['time']; ?>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="4" valign="top"><strong>ATTENDEES:</strong>
<table width="65%" border="0" cellpadding="0" cellspacing="0" id="attendee_table" >
        <tr>
          <th width="41%" align="left"  height="25" >Name </th>
          <th width="59%" align="left" height="25" >Company</th>
          </tr>
        <?php $i=0; $attndeeNames = "";
			if(isset($meetingAttendeeData) && !empty($meetingAttendeeData)){
				foreach($meetingAttendeeData as $key=>$meetAttendee){ $i++;
					$attndeeNames.= ($attndeeNames == "")? "'".$meetAttendee['attendees_name']."'": ", '".$meetAttendee['attendees_name']."'";
			?>
        <tr id="tr_<?php echo $i;?>">
          <td height="22" ><?php echo $meetAttendee['attendees_name']; ?>&nbsp;</td>
...
function generatePrint(meetingId){
	...
	modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'pmb_agenda_template_report.php?'+params, loadingImage);
...
function downloadPDF(callback){
	showProgress();
	$.ajax({
		url:  'pdf/pmb_agenda_template_report.php',
		type: "POST",
