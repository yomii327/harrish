...
if(isset($_REQUEST["antiqueID"])){
	if(isset($_POST['task'])){
		$select = "SELECT id, task_name FROM qa_project_checklist_task WHERE task_name = '".addslashes(trim($_POST['task']))."' AND project_checklist_id = '". $_POST['checklistId'] ."' AND is_deleted = 0";
		...
		// }else{
			$task_query = "project_checklist_id = '".addslashes(trim($_POST['checklistId']))."',
			...
			mysql_query("INSERT INTO qa_project_checklist_task SET ".$task_query);
...
if(isset($_REQUEST["name"]) && isset($_REQUEST["checklistId"])){
	...
	$checklistData = $obj->selQRYMultiple('*', "check_list_items_project", " is_deleted = '0' AND id = '".$_REQUEST["checklistId"]."'");	
...
<style>
	...
	<fieldset class="roundCorner">
		...
		<table width="550" border="0" align="left" cellpadding="0" cellspacing="15">
			...
			<tr>
				<td valign="top" align="left" style="color:#000000;">Task <span class="req">*</span></td>
				<td align="left">
			...
			<tr>
				<td valign="top" align="left" style="color:#000000;">Hold Point?</td>
				<td align="left">
			...
			<tr>
				<td valign="top" align="left" style="color:#000000;">Comment Mandatory?</td>
				<td align="left">
			...
			<tr id="commentMandatory">
				<td valign="top" align="left" style="color:#000000;">Instructions <span class="req" id="commentStar"></span></td>
				<td align="left">
			...
			<tr>
                ...
                <input type="button" name="button" class="green_small" id="button" style="float:left;" onclick="addProjectTaskData(<?php echo $checklistData['id']; ?>);" value="Submit"/>
                &nbsp;&nbsp;&nbsp; <a id="ancor" href="javascript:editProjectChecklistData(<?php echo $checklistData['id']; ?>);" onclick="yes" class="green_small">Back</a>
				</td>
			</tr>
		</table>
		</form>
