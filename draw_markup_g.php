...
#imgSVG{ display: block; position: fixed; }
#editor { position: absolute !important; z-index: 100; height: 100%; width: 100%; }
</style>
...
<script language="javascript" type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/0.4.0/html2canvas.min.js"></script>
...
<div class="markup-container">
    <div class="page-title">
        ...
        <!-- /.hotSpotCreateContainer onclick="drawPencil()"  -->
    </div>
    <div class="markup-section">
        ...
        <br />
        <br />
        <div class="button" style="margin-right: 10px;float: left;"> <a class="green_small" href="?sect=drawing_register&type=pmb&id=<?php echo $drProjectId; ?>">Back</a> </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		alert('Welcome Dude to defectID.');
	});
</script>
