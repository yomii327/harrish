...
if(isset($_REQUEST['name'])){//Set Session for back implement and Remeber   
    ...
    <div style="color:black;" id="qa-view-checklist">
        <ul class="buttonHolder">
            ...
            <a href="pdf/qa_checklist_pdf.php?qaChecklistId=<?php echo $_REQUEST['qaChecklistId'] . '&projID=' . $_REQUEST['projID']; ?>" alt="Print Screen" class="green_small" style="float:right;margin:15px 15px 0 0;cursor:pointer;">Download
            </a>
        </ul><br clear="all">
