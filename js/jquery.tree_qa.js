			...
			jQuery.ajax({
				...
				success: function(data){ 
					...
					$('span.demo1').contextMenu('myMenu2', {
						bindings: {
							'add': function(t) { 
								modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'location_tree_add_qa.php?location_id='+t.id, loadingImage);
							},
							'edit': function(t) {
								var parentId = $('#'+t.id).parent().parent().parent().get(0);
								modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'location_tree_edit_qa.php?location_id='+t.id+'&parent_id='+parentId.id, loadingImage);
							},
							'delete': function(t) {
							...
							'addTask': function(t) {
								modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'add_task_qa.php?sub_location_id='+t.id+'&uniqueId='+Math.random(), loadingImage);
							},
						}
					});
					...
					$('span.demo3').contextMenu('myMenu3', {
						bindings: {
							'viewTask': function(t) {
								modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'view_task_qa.php?task_id='+t.id+'&uniqueId='+Math.random(), loadingImage);
							},
							'editTask': function(t) {
								modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, 'edit_task_qa.php?task_id='+t.id+'&uniqueId='+Math.random(), loadingImage);
							},
