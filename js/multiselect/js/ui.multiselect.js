  ...
  options: {
    ...
    **************************************/
	...
	_getOptionNode: function(option) {
		option = $(option);
		var node = $('<li class="ui-state-default ui-element"><span class="ui-icon "/><a href="#" class="action" style="position:relative !important; width:300px;">'+option.text()+'</a><a href="#" class="ui-state-default action"><span class="ui-corner-all ui-icon"/></a></li>').hide();
