...
$(document).ready(function() {
    ...
    $(document).on('touchstart click', '#hotSpotCreate1', function() {
        //drawing = false;
        //$("#hotspotimg").removeClass('textClass');
    ...
    try{
        ...
        if(svg != null){
			...
			svgAsDataUri(d3.select('svg').node(), {}, function(uri) {
	            ...
	            xhttp.open('POST', 'imageSaveMail.php?type=svg', false);
...
function saveHotspot(x,y) {
   
    var title =  $("#title").val();

    var divTag = document.createElement('div'); // creates the element
 
    //divTag.id = "div1"; 
    divTag.style.left = x+'px';
    divTag.style.top = y+'px';
    divTag.style.position = 'absolute';
    divTag.style.color = '#ff0000';    
    //divTag.style.margin = "0px auto"; 
    divTag.innerHTML = title; 
     
    document.getElementById('pdfContent').appendChild(divTag); 
