...
$(document).ready(function() {
    ...
    */
    ...
    $('#hotSpotCreate1', window.parent.document).click(function() {
        ...
        $('#pdfContentNew').append(str_image_div); //Active condition Section Here
        ...
        $(".resizableTag").draggable({
            ...
            drag: function(evt, ui) {
                ...
                var canvasHeight = $('#pdfContentNew').height();
                var canvasWidth = $('#pdfContentNew').width();
                var zscale = $("#pdfContentNew").css('transform');
    ...
    //$("#pdfContentNew").html(data);
    $("#pdfContentNew").show();
    $("#pdfContentNew").css('transform', 'scale(1)');
    ...
    var sketchpad = Raphael.sketchpad("editors", {
        height: '100%',
        width: '100%',
...
function saveHotspotImage() {
    //reset();
    showProgress();
    var element = $('#pdfContentNew');

    html2canvas(element,{height: 1590,
        onrendered: function(canvas) {
            ...
            xhttp.open('POST', 'draw_markup_mail.php', false);
