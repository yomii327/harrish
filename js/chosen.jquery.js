  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_text = function() {
      ...
      if (this.form_field.getAttribute("data-placeholder")) {
        ...
        this.default_text = this.options.placeholder_text_multiple || this.options.placeholder_text || "Select";
      } else if (this.allow_custom_value) {
        this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || "Type or Select an recipient";
      } else {
        this.default_text = this.options.placeholder_text_single || this.options.placeholder_text || "Select an recipient";
      }
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      return this.allow_custom_value = this.form_field_jq.hasClass("chzn-custom-value" || this.options.allow_custom_value);
    };
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
		...
		/* Start : Meeting section validation */
		if ($('#meetingId').length){		
			var attendeeIdNo = high_id.split("_");
			//alert(idNo[2]);
			var cmpNameitem = item.text.split("( ");
			cmpNameitem = (cmpNameitem[1])?cmpNameitem[1].split(" )"):'';
			$("#companyName_"+attendeeIdNo[2]).val(cmpNameitem[0]);
			$("#companyName_"+attendeeIdNo[2]).css("text-transform", "capitalize");
		}
		/* End : Meeting section validation */
		...
		if (this.container_id == 'RFInumber_chzn'){
			/* Start RFI validation */
			if (value == '' || value > 0 ) {
	 	...
	 	}else if ($('#customEmailEntry').length == true && this.container_id != 'RFInumber_chzn'){
			/* Start Email validation */
			var filter = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
			if (filter.test(value)) {
				$('#emailError').hide();
				if($('#customEmailEntry').val()==""){
					$('#customEmailEntry').val(value);
				}else{
					$('#customEmailEntry').val($('#customEmailEntry').val()+", "+value);					
				}
