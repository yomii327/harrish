function modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, url, loadingImage, callback){
	...
	var popupDiv = document.getElementById('outerModalPopupDiv');
	if (popupDiv == null){
		containerid = "innerModalPopupDiv";
...
//		blockDiv.setAttribute('onClick', 'closePopup(' + fadeOutTime + ')');
		...
		closeDiv.setAttribute('id', 'closeModalPopupDiv');
		closeDiv.setAttribute('class', 'closeModalPopupDiv');
		closeDiv.setAttribute('onClick', 'closePopup(' + fadeOutTime + ')');
	
		imageClose.setAttribute('id', 'closeImage');
		imageClose.setAttribute('class', 'closeImage');
		imageClose.setAttribute('onClick', 'closePopup(' + fadeOutTime + ')');
	...
	document.getElementById('closeModalPopupDiv').style.width = 30+'px';
	document.getElementById('closeModalPopupDiv').style.height = 30+'px';
	document.getElementById('closeModalPopupDiv').style.position = 'absolute';
	document.getElementById('closeModalPopupDiv').style.zIndex = 100;
	document.getElementById('closeModalPopupDiv').style.top = -13 + 'px';
	document.getElementById('closeModalPopupDiv').style.right = -14 + 'px';
	document.getElementById('closeModalPopupDiv').style.cursor = 'pointer';
...
function closePopup(fadeOutTime) {
	...
	var rem = document.getElementById('closeModalPopupDiv');
