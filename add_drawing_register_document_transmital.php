...
#	move_uploaded_file($_FILES['drawingPDF']['tmp_name'], './project_drawing_register/'.$_SESSION['idp'].'/'.$imageName);
		...
		<table width="550" border="0" align="left" cellpadding="0" cellspacing="15">
			<tr>
				...
				<td align="left" width="50%">
					<div class="innerDiv" id="innerDivDocumentTransmital" align="center">
