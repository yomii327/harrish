...
$q = "SELECT * FROM progress_monitoring pr 
			  LEFT JOIN project_locations l ON l.location_id= pr.location_id 
			  WHERE pr.project_id ='".$_SESSION['idp']."' and pr.is_deleted=0";
