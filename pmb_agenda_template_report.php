...
<br />
<h1 style="background:#000000; color:#FFFFFF; padding:5px; display:block; clear:both; margin-top:70px; padding-left:20px;">AGENDA </h1>
 <table width="98%" border="0" style=" margin:10px;" cellpadding="2" cellspacing="5">
  ...
  <tr>
    <td height="22" colspan="4" valign="top"><strong><?php echo $meetingData[0]['title']; ?>&nbsp;</strong><br />
	<?php echo $meetingData[0]['held_at']; ?><br />
	<?php echo $meetingData[0]['meeting_location']; ?>
    &nbsp;</td>
    </tr>      
  <tr>
