...
if(isset($_POST['submit'])){
	if(!empty(trim($_POST['description'])) && !empty(trim($_POST['date'])) && !empty(trim($_POST['time']))){
		...
		if(isset($_POST['meetingId']) && $_POST['meetingId']==0){
			...
			$insert_meetingDetails = "INSERT INTO meeting_details SET
									...
									title = '".addslashes(trim($_POST['description']))."',
									held_at = '".addslashes(trim($_POST['heldAt']))."',
		...
		<script language="javascript" type="text/javascript">window.location.href="<?="?sect=meeting&folderType=".$_GET['folderType']; ?>";</script>
<?php }else{
...
#attendee_table .input_small{ height:22px}
 ...
 <form action="" method="post" enctype="multipart/form-data" name="pmb_agenda_template_form" id="pmb_agenda_template_form" >
 <table width="98%" border="0" style=" border:1px solid #333; margin:10px;" cellpadding="5" cellspacing="5">
  ...
  <tr>
    <td width="24%" height="27" valign="top" ><strong>Agenda for meeting number</strong></td>
  ...
  <tr>
    <td valign="top"><strong>Meeting Description <span class="req">*</span></strong></td>
    <td colspan="3" valign="top"><textarea type="text" size="40" id="description" name="description"  class="input_small" style="width: 306px; height:50px; "><?php echo $meetingData[0]['title']; ?></textarea></td>
    </tr>
  <tr>
    <td height="27" valign="top" ><strong>Held at </strong></td>
    <td colspan="3" valign="top"><input name="heldAt" type="text" class="input_small1" id="heldAt" style="width:310px; " value="<?php echo $meetingData[0]['held_at']; ?>" size="" maxlength=""/></td>
  </tr>
  <tr>
    ...
    <td width="7%" valign="top"><strong>Time  <span class="req">*</span></strong></td>
  ...
  <tr>
    <td colspan="3" align="right" valign="top"><a style="float: none;height: 44px; width: 87px; cursor:pointer;" onclick="javascript:history.back(-1);"><img src="images/back_btn.png"></a></td>
