...
//Get pdfData Here
	...
	$recodArr['attribute1'] = $pdfExData[0]['attribute1'];
	...
	//Add file for email attachment 
		...
		copy("project_drawing_register/".$_SESSION['idp']."/".$imageName, 'attachment/'.$name);
	//Add file for email attachment 
...
if(isset($_REQUEST["name"])){
	$drawingData = $obj->selQRYMultiple('attribute1, attribute2', 'drawing_register', 'is_deleted = 0 AND id = '.$_REQUEST["tableID"]);
?>
	<fieldset class="roundCorner">
		<legend style="color:#000000;">Add Drawing Register Revision</legend>
