...
<div class="markup-container">
	<div class="page-title">
		<h1><img src="images/b_head_doccument_register.png" width="18px" height="18px" alt="image" /> Document Register- Draw Markup 
		     <!-- <div id="zoomout">Zoom Out</div> <div id="zoomIn" >Zoom In</div> -->
		    <button class="green_small btn-back pull-right" style="margin-left: 8px;" onclick="confirmMail('<?=$drProjectId?>');">Mail</button> 
