...
//
	...
	if(array_key_exists($fetchKey, $existDrawingArr)){
		$exDrawingID = $existDrawingArr[$fetchKey];

		$insertQRY = "INSERT INTO drawing_register_revision SET
				project_id = '".$_SESSION['idp']."',
				drawing_register_id = '".addslashes($exDrawingID)."',
				revision_number = '".addslashes($drawingRevision)."',
				revision_status = '".addslashes($pdfStatus)."',
