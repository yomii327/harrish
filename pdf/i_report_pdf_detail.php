...
//echo ini_get('max_execution_time') . '<<==max execution time=='; die();
...
/*	 	if(!empty($_POST['location']) && isset($_POST['location'])){
			$html .= '<td width="140" style="font-size:11px;" valign="top""><b>Location Name : </b></td>
			<td width="110" style="font-size:11px;" valign="top"">'.$obj->getDataByKey('project_locations', 'location_id', $_POST['location'], 'location_title').'</td>';$jk++;
		}*/
		...
		if(!empty($_POST['inspectedBy']) && isset($_POST['inspectedBy'])){
			...
			<td width="110" style="font-size:11px;" valign="top"">'.$_POST['inspectedBy'].'</td>';
			$jk++; if($jk%2 !=0){$html .= '';}if($jk%2 ==0){$html .= '</tr><tr>';}
		}
		...
		if(!empty($_POST['priority']) && isset($_POST['priority'])){
			...
			<td width="110" style="font-size:11px;" valign="top"">'.$_POST['priority'].'</td>';
			$jk++; if($jk%2 !=0){$html .= '';}if($jk%2 ==0){$html .= '</tr><tr>';}
		}
		if(!empty($_POST['inspecrType']) && isset($_POST['inspecrType'])){
			...
			<td width="110" style="font-size:11px;" valign="top"">'.$_POST['inspecrType'].'</td>';
			$jk++; if($jk%2 !=0){$html .= '';}if($jk%2 ==0){$html .= '</tr><tr>';}
		}
		if(!empty($_POST['costAttribute']) && isset($_POST['costAttribute'])){
			...
			<td width="110" style="font-size:11px;" valign="top"">'.$_POST['costAttribute'].'</td>';
			$jk++; if($jk%2 !=0){$html .= '';}if($jk%2 ==0){$html .= '</tr><tr>';}
		}
		...
		if(!empty($_POST['DRF']) && isset($_POST['DRF']) || !empty($_POST['DRT']) && isset($_POST['DRT']))
		{
			...
			<td width="110" style="font-size:11px;" valign="top"">'.$_POST['DRF'].' to '.$_POST['DRT'].'</td>';
			$jk++; if($jk%2 !=0){$html .= '';}if($jk%2 ==0){$html .= '</tr><tr>';}
		}
		if(!empty($_POST['FBDF']) && isset($_POST['FBDF']) || !empty($_POST['FBDT']) && isset($_POST['FBDT']))
		{
		   ...
		   <td width="110" style="font-size:11px;" valign="top""">'.$_POST['FBDF'].' to '.$_POST['FBDT'].'</td>';
			$jk++; if($jk%2 !=0){$html .= '';}if($jk%2 ==0){$html .= '</tr><tr>';}
		}
