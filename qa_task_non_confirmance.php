	...
	<form name="addEvedenceForm" id="addEvedenceForm">
		<table width="100%" border="0" align="left" cellpadding="0" cellspacing="15" style="color:#000;">
			...
			<tr>
				...
				<td align="left">
					<textarea name="description" id="description" class="text_area" ><?php if($evdenceData) {echo $evdenceData['qa_inspection_description']; }?></textarea>
			...
			if(isset($qa_issued) && !empty($qa_issued))
			{
				...
				<tr id="hide_<?php echo $value['qa_issued_to_id'];?>" class="issueToPluse">
					...
					<td width="30%">
						<select name="issuedto[]" type="text" id="Issuedto<?php echo $i;?>" class="nonselect">	
					...
					$newDate = date("d-m-Y", strtotime($originalDate));
					 echo $newDate; }else{ echo "";} ?>" type="text" id="fixedByDate_<?php echo $i-1;?>" class="nonselect">	
					</td>
					<td width="30%">
						<select name="status[]" type="text" id="Status" class="nonselect">	
...
<?php
			...
			<tr>
				<td></td>
				<td>
	            	<input type="button" name="button" class="green_small" id="button" style="float:left;" onclick="addTaskNonconfirmance();" value="Submit"/>
	            </td>
	            <td>
