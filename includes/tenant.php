...
$(document).ready(function() {
	var validator = $("#TenantLogin").validate({
	rules:
	{  
	   username:
	   {
...
<div class="content_center">
	<form action="wwConroller.php" id="TenantLogin" method="post"  enctype="multipart/form-data" >
		<div class="content_hd" style="background-image:url(images/tenants_hd.png);"></div>
		...
		<div class="signin_form">
			<table width="470" border="0" align="left" cellpadding="0" cellspacing="15">
             ...
             <?php if(isset($_SESSION['error']['password']) && $_SESSION['error']['password']!=""){?>
				...
				<tr>
					<td valign="top">&nbsp;</td>
					<td colspan="2" valign="top"><a href="?sect=forgot_password&type=2">Forgot Password</a></td>
				</tr>
				<tr>
					<td valign="top">&nbsp;</td>
					<td colspan="2" valign="top" align="left">
					  <input type="hidden" value="tenant_sign_in" name="sect" id="sect" />
