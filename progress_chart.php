...
while($f1=$obj->db_fetch_assoc($p_m)){
	...
	$lenght=strlen($project_name1);
	 if($lenght>17)
	 {
		$proj_name_new_pm=	 '"<center>'.substr($project_name1,0,17).'..<br/>' . $total . ' tasks<center>"';
	}
	else
	{
		$proj_name_new_pm='"<center>'.$project_name1.'<br/>' . $total . ' tasks<center>"';	
	}
    $project_name[] =  $proj_name_new_pm;
		 
	    // $project_name[] =  '"<center>'.substr($project_name1,0,15).'..<br/>' . $total . ' tasks<center>"';
}
