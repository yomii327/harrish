...
//issue to data fetch here
	...
	$toEmailIDS['reportType'] = 'Summary Report without Notes';
...
$html = '<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		if($offset == 0){
			$html .= '
				<tr>
					<td width="40%" style="font-size:14px;"><u><b>Summary Report without Notes</b></u></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
		...
		<td widht="3%" style="font-size:10px" align="center"><strong>Inspecton Type</strong></td>';
...
if($issueData['inspection_status'] == 'Closed'){ $isClosed = 'Closed'; }
	...
	$html .= '<td width="5%"><font style="font-size:10px;">'.stripslashes(wordwrap($fi["InspectedBy"], 15, "<br />", true)).'</font></td>
			...
			<!--td width="4%" align="center"><font style="font-size:10px;">'.stripslashes(date("d/m/Y", strtotime($fi["closedDate"]))).'</font></td-->';
			if($report_type == "pdfSummayWithImages"){
