...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 */
			this.iCookieDuration = 60 * 60 * 500;
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" id="dropDown" onchange=setDropValue(this.value); '+sName+'>';
			var i, iLen;
			 ...
			 */
			if (typeof dropDownSelect != 'undefined') {
				oSettings._iDisplayLength = dropDownSelect;	
			}
...
//Custom Code	
	jQuery.fn.dataTableExt.oApi.fnDisplayStart = function ( oSettings, iStart, bRedraw ){
		console.log( oSettings, iStart, bRedraw );
